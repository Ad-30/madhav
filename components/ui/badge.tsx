  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        delivered:
          "border-transparent bg-status-delivered text-status-delivered-foreground hover:bg-status-delivered/80",
        shipped:
          "border-transparent bg-status-shipped text-status-shipped-foreground hover:bg-status-shipped/80",
